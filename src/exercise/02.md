...
I learned how to use the `useCallback` hook to memoize functions. This hook is useful for adding functions as a depdencency. I designed a custom hook that returned a memoized run function that the user of the API can call.
